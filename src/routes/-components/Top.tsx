  ...
  return (
    <>
      ...
      <div className={ButtonStyle}>
        <SimpleButton buttonName='Page to Register' onClick={() => navigate({ to: PATH.REGISTER })} />
      </div>
      <div className={ButtonStyle}>
        <SimpleButton color='info' buttonName='Page to Customer' onClick={() => navigate({ to: PATH.CUSTOMER })} />
      </div>
    </>
  );
};
